...
class Coffee {
    fun coffOrder(cart: Cart) {
        ...
        while (true) {
            ...
            when (cPick.toInt()) {
                1 -> {
                    val americano = PickList("아메리카노", 5000, 1)
                    println(" ---------------------------------------------------------------------------------------------------")
                    ...
                    // 선택한 품목, 값, 합계, 잔액 표시
                    if (cPick.toInt() >= 1) {
                        val price = PickList("아메리카노", 5000, 1 * cPick.toInt())
                ...
                2 -> {
                    val latte = PickList("카페라떼", 6000, 1)
                    println(" ---------------------------------------------------------------------------------------------------")
                    ...
                    // 선택한 품목, 값, 합계, 잔액 표시
                    if (cPick.toInt() >= 1) {
                        val price = PickList("카페라떼", 6000, 1 * cPick.toInt())
                        cart.addPickList(price) // 윗줄에서 계산한 값을 보여줌
                        price.priceDisplayInfo() // 가격 합계 보여줌
                ...
                3 -> {
                    val macchiato = PickList("카라멜마끼아또", 8000, 1)
                    println(" ---------------------------------------------------------------------------------------------------")
                    ...
                    // 선택한 품목, 값, 합계, 잔액 표시
                    if (cPick.toInt() >= 1) {
                        val price = PickList("카라멜마끼아또", 8000, 1 * cPick.toInt())
                        cart.addPickList(price) // 윗줄에서 계산한 값을 보여줌
                        price.priceDisplayInfo() // 가격 합계 보여줌
                ...
                4 -> {
                    val affogato = PickList("아인슈페너", 7000, 1)
                    println(" ---------------------------------------------------------------------------------------------------")
                    ...
                    // 선택한 품목, 값, 합계, 잔액 표시
                    if (cPick.toInt() >= 1) {
                        val price = PickList("아인슈페너", 7000, 1 * cPick.toInt())
                        cart.addPickList(price) // 윗줄에서 계산한 값을 보여줌
                        price.priceDisplayInfo() // 가격 합계 보여줌
                ...
                5 -> {
                    val espresso = PickList("에스프레소", 6000, 1)
                    println(" ---------------------------------------------------------------------------------------------------")
                    ...
                    // 선택한 품목, 값, 합계, 잔액 표시
                    if (cPick.toInt() >= 1) {
                        val price = PickList("에스프레소", 6000, 1 * cPick.toInt())
                        cart.addPickList(price) // 윗줄에서 계산한 값을 보여줌
                        price.priceDisplayInfo() // 가격 합계 보여줌
